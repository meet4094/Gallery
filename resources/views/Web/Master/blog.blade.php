        ...
        <div class="row d-flex justify-content-center">
            ...
            <div class="col-lg-12">
                <div class="blog__details__pic">
                    <img src="{{asset('web/assets/img/blog/details/blog-details-pic.jpg')}}" alt="" />
                </div>
            </div>
            <div class="col-lg-8">
                <div class="blog__details__content">
                    ...
                    <div class="blog__details__item__text">
                        ...
                        <img src="{{asset('web/assets/img/blog/details/bd-item-1.jpg')}}" alt="" />
                        <p>
                    ...
                    <div class="blog__details__item__text">
                        ...
                        <img src="{{asset('web/assets/img/blog/details/bd-item-2.jpg')}}" alt="" />
                        <p>
                            In Japan the idea of a first-year speaking to a senior the way
                            Kageyama did to Asahi is a lot more shocking than it would be
                            in the West, but Tobio calling out teammates in genuinely rude
                    ...
                    <div class="blog__details__item__text">
                        <h4>ID:Ianvaded:</h4>
                        <img src="{{asset('web/assets/img/blog/details/bd-item-3.jpg')}}" alt="" />
                        <p>
                            In Japan the idea of a first-year speaking to a senior the way
                            Kageyama did to Asahi is a lot more shocking than it would be
                            in the West, but Tobio calling out teammates in genuinely rude
...
<script type="text/javascript">
    ...
    $.ajax({
            ...
            success: function(response) {
                if (response.st == 'success') { // console.log(response.category); $.each(response.category, function(prefix, val) { $('#category_data').append( `<li><a class="{{ @$title == 'categories' ? 'active' : '' }}" href="{{url('CategoryByPersonData')}}/${val.id}">${val.name}</a></li>`
                )
            })
    }
    else {
